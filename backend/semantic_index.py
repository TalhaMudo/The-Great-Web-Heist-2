...
class SemanticIndexService:
    """Optional vector index backed by sentence-transformers.

    The semantic engine runs as an independent task that pulls already-crawled
    pages out of SQLite and adds embeddings on its own schedule, so it does not
    block the crawler or search service.
    """
